...
my %LIB_RECORD_TYPES = map { $_ => 1 } 0x96, 0x98, 0xa0, 0xa1, 0xa2, 0xa3, 0x90, 0xb6, 0x8c, 0xb4, 0x9c, 0x8a;
my %LIB_OMITTED_RECORD_TYPES = map { $_ => 1 } 0x80, 0x82, 0x88, 0x9a;
my %LIB_DISALLOWED_RECORD_TYPES = map { $_ => 1 } 0x91, 0xb7, 0xb5, 0x9d, 0x8b;
